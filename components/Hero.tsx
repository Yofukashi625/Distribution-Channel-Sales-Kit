  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-slate-50 overflow-hidden">
      ...
      <div className="z-10 container mx-auto px-6 text-center">
        ...
        >
          <FangYangLogo className="w-40 md:w-56 h-auto drop-shadow-xl" />
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-8xl font-black text-slate-800 tracking-tight">
            擁抱未知，探索本質
          </h1>
        ...
        <motion.div
          ...
          className="text-lg md:text-xl text-slate-400 mb-16 max-w-2xl mx-auto"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {STATS_DATA.map((stat, index) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-bold text-[#F7005A] mb-2">
                {stat.value}<span className="text-xl text-slate-500 ml-1">{stat.suffix}</span>
              </div>
